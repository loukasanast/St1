...
<!DOCTYPE html>
    <html lang="en">
        ...
        <body>
            <h2 class="title ml-4 mt-4">Update student</h2>
            <form:form action="updatepost" modelAttribute="student">
                <table class="table ml4">
                    <tr>
                        <td>First Name:</td>
                        <td>
                ...
                <form:hidden path="id" />
                <button class="button is-light ml-4" type="submit">Update</button>
            </form:form>
